...
(function () {
  ...
  style.textContent = [
    ...
    '#nb-schedule .success-ring{width:56px;height:56px;border-radius:999px;display:flex;align-items:center;justify-content:center;background:linear-gradient(160deg,#1FB866,#0E8C49);color:#fff;box-shadow:0 13px 30px -12px rgba(20,158,85,.5),0 0 0 6px rgba(20,158,85,.10);margin-bottom:14px;animation:nbpop .5s cubic-bezier(.2,.8,.2,1.2) both}',
    '#nb-schedule .success-ring svg{width:28px;height:28px}',
    ...
    '#nb-schedule .cal{width:100%;max-width:640px;margin:16px auto 0;background:#fff;border:1px solid var(--line);border-radius:20px;box-shadow:0 26px 60px -30px rgba(10,22,40,.34);padding:8px;overflow:hidden}',
